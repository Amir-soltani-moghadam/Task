...
{
    public class CreateSalaryCalculationCommandHandler : IRequestHandler<CreateSalaryCalculationCommandRequest, SalaryCalculationDto>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IDataParser _dataParser;
        private readonly IMapper _mapper;

        public CreateSalaryCalculationCommandHandler(IUnitOfWork unitOfWork, IDataParser dataParser, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _dataParser = dataParser;
            _mapper = mapper;
        }
        public async Task<SalaryCalculationDto> Handle(CreateSalaryCalculationCommandRequest request, CancellationToken cancellationToken)
        {
